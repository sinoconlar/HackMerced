...
const illnesses = {
    ...
    'Kidney Stone': ['severe pain', 'painful urination', 'blood in urine'],
    'Allergies': ['sneezing', 'runny', 'stuffy nose', 'itchy', 'watery eyes'],
    ...
    'Urinary Tract Infection': ['frequent urination', 'burning sensation', 'bloody urine'],
    ...
    'Thyroid': ['fatigue', 'weight gain', 'weight loss', 'sensitivity to cold', 'sensitivity to heat'],
    ...
    'Bone Fracture': ['swelling', 'severe pain', 'deformity', 'aches'],
    ...
    'Muscle Spasm': ['stiffness', 'severe pain', 'ontractions', 'muscle aches', 'aches']
}
